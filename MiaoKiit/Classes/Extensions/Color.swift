...
public extension UIColor {
    ...
    /// 舒适的黑色
    static let niceBlack = UIColor.init(0x1E2028)
    /// 舒适的红色
    static let niceRed = UIColor.init(0xED4252)
...
public extension UIColor {
    ...
    /// - Parameters:
    ///   - light: 正常模式颜色
    ///   - dark: 暗黑模式颜色，未输入时返回light反色
    /// - Returns: 颜色
    static func `for`(light: UIColor, dark: UIColor? = nil) -> UIColor {
        if #available(iOS 13.0, *) {
            if let dark = dark {
