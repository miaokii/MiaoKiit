...
public extension UITableView {
    ...
    convenience init(super view: UIView?,
                     frame: CGRect = .zero,
                     style: Style = .plain,
                     delegate delegateObject: UITableViewDelegate? = nil,
                     dataSource dataSourceObject: UITableViewDataSource? = nil,
        ...
        if let object = delegateObject {
            delegate = object
        }
        
        if let object = dataSourceObject {
            dataSource = object
        }
